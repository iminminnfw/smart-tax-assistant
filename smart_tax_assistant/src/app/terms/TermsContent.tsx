      ...
      <div className="bg-white p-8 sm:p-10 rounded-2xl shadow-lg border border-gray-100">
       ...
       focus:ring-blue-500 focus:ring-offset-2 transform hover:-translate-y-0.5">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <p>
            ระบบปัญญาประดิษฐ์ (AI) ของเราได้รับการออกแบบมาเพื่อช่วยจำลองสถานการณ์และให้คำแนะนำเบื้องต้น
            อย่างไรก็ตาม เทคโนโลยี AI อาจมีความคลาดเคลื่อนในการประมวลผล
            ผู้ใช้บริการควรตรวจสอบความถูกต้องของตัวเลข เงื่อนไขทางกฎหมายภาษี
            และพิจารณาข้อจำกัดของตนเองอีกครั้งก่อนนำข้อมูลไปใช้ยื่นแบบแสดงรายการภาษีต่อกรมสรรพากรจริง
            บริษัทขอสงวนสิทธิ์ไม่รับผิดชอบต่อเบี้ยปรับ เงินเพิ่ม หรือความเสียหายทางภาษีใดๆ ที่อาจเกิดขึ้น
          </p>
