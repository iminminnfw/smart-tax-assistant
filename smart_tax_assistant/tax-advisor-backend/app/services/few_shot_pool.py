    ...
    EXAMPLES = {
            ...
            "plans": [
                {
                    ...
                    "description": "เน้นความคุ้มครองชีวิตและสุขภาพเป็นหลัก เหมาะสำหรับผู้มีรายได้ไม่สูงที่ต้องการประกันพื้นฐานพร้อมลดหย่อนภาษี",
                    "allocations": [
                ...
                {
                    "plan_type": "balanced",
                    "description": "กระจายความเสี่ยงระหว่างประกันและกองทุน RMF สมดุลระหว่างความคุ้มครองและการออมระยะยาว",
                    "allocations": [
                ...
                {
                    "plan_type": "growth",
                    "description": "เน้นลดหย่อนภาษีเต็มวงเงิน ใช้ RMF ร่วมกับประกันครบด้านเพื่อประหยัดภาษีสูงสุด",
                    "allocations": [
        ...
        ("low", "medium"): {
            "plans": [
                {
                    "plan_type": "conservative",
                    "description": "เน้นความคุ้มครองด้วยประกันชีวิตและสุขภาพ เงินลงทุนพอเหมาะสำหรับรายได้ระดับต้น",
                    "allocations": [
                ...
                {
                    "plan_type": "balanced",
                    "description": "กระจายความเสี่ยงระหว่างประกันและกองทุน RMF สมดุลระหว่างความคุ้มครองและการเติบโต",
                    "allocations": [
                ...
                {
                    "plan_type": "growth",
                    "description": "เน้นลดหย่อนภาษีสูงสุด ผสม RMF กับ ThaiESG ใช้วงเงินเต็มที่เพื่อผลตอบแทนระยะยาว",
                    "allocations": [
        ...
        ("low", "high"): {
            "plans": [
                {
                    "plan_type": "conservative",
                    "description": "เน้นความคุ้มครองพื้นฐานด้วยประกันชีวิตและสุขภาพ สร้างฐานความมั่นคงแม้รายได้ไม่สูง",
                    "allocations": [
                        {"category": "ประกันชีวิต", "percentage": 45, "risk_level": "low",
                         "pros": ["ให้ความคุ้มครองชีวิต"], "cons": ["ผลตอบแทนต่ำ"]},
                        {"category": "ประกันสุขภาพ", "percentage": 20, "risk_level": "low",
                ...
                {
                    "plan_type": "balanced",
                    "description": "กระจายความเสี่ยงระหว่างประกันและกองทุนหุ้น RMF สมดุลระหว่างความคุ้มครองและการเติบโต",
                    "allocations": [
                        {"category": "ประกันชีวิต", "percentage": 20, "risk_level": "low",
                         "pros": ["ให้ความคุ้มครองชีวิต"], "cons": ["ผลตอบแทนต่ำ"]},
                        {"category": "ประกันสุขภาพ", "percentage": 10, "risk_level": "low",
                ...
                {
                    "plan_type": "growth",
                    "description": "เน้นลดหย่อนภาษีสูงสุดด้วย RMF และ ThaiESG ใช้วงเงินเต็มที่เพื่อผลตอบแทนสูง",
                    "allocations": [
                        {"category": "ประกันชีวิต", "percentage": 15, "risk_level": "low",
                         "pros": ["ให้ความคุ้มครองชีวิต"], "cons": ["ผลตอบแทนต่ำ"]},
        ...
        ("medium", "low"): {
            "plans": [
                {
                    "plan_type": "conservative",
                    "description": "เน้นความคุ้มครองครอบคลุมด้วยประกันชีวิตและสุขภาพ เหมาะกับรายได้ระดับกลางที่ต้องการความปลอดภัย",
                    "allocations": [
                ...
                {
                    "plan_type": "balanced",
                    "description": "กระจายความเสี่ยงเน้นประกันและกองทุนบำนาญ สมดุลระหว่างความคุ้มครองและการออมระยะยาว",
                    "allocations": [
                        {"category": "ประกันชีวิต", "percentage": 20, "risk_level": "low",
                         "pros": ["ให้ความคุ้มครองชีวิต"], "cons": ["ผลตอบแทนต่ำ"]},
                        {"category": "ประกันสุขภาพ", "percentage": 10, "risk_level": "low",
                ...
                {
                    "plan_type": "growth",
                    "description": "เน้นลดหย่อนภาษีเต็มวงเงินแบบปลอดภัย ใช้ RMF ร่วมกับประกันบำนาญเพื่อประหยัดภาษีสูงสุด",
                    "allocations": [
                        {"category": "ประกันชีวิต", "percentage": 15, "risk_level": "low",
                         "pros": ["ให้ความคุ้มครองชีวิต"], "cons": ["ผลตอบแทนต่ำ"]},
        ...
        ("medium", "medium"): {
            "plans": [
                {
                    "plan_type": "conservative",
                    "description": "เน้นความคุ้มครองด้วยประกันชีวิตและสุขภาพ เงินลงทุนพอเหมาะสำหรับรายได้ระดับกลาง",
                    "allocations": [
                        {"category": "ประกันชีวิต", "percentage": 35, "risk_level": "low",
                         "pros": ["ให้ความคุ้มครองชีวิต", "ลดหย่อนภาษี"], "cons": ["ผลตอบแทนต่ำ"]},
                        {"category": "ประกันสุขภาพ", "percentage": 15, "risk_level": "low",
                ...
                {
                    "plan_type": "balanced",
                    "description": "กระจายความเสี่ยงอย่างสมดุลระหว่างประกันและกองทุน RMF เพื่อความคุ้มครองและการเติบโตควบคู่กัน",
                    "allocations": [
                        {"category": "ประกันชีวิต", "percentage": 20, "risk_level": "low",
                         "pros": ["ให้ความคุ้มครองชีวิต"], "cons": ["ผลตอบแทนต่ำ"]},
                        {"category": "ประกันสุขภาพ", "percentage": 10, "risk_level": "low",
                ...
                {
                    "plan_type": "growth",
                    "description": "เน้นลดหย่อนภาษีสูงสุด ใช้วงเงินลงทุนเต็มที่ใน RMF และ ThaiESG เพื่อผลตอบแทนระยะยาว",
                    "allocations": [
        ...
        ("medium", "high"): {
            "plans": [
                {
                    "plan_type": "conservative",
                    "description": "เน้นความคุ้มครองพื้นฐานด้วยประกันชีวิตและสุขภาพ สร้างฐานความมั่นคงสำหรับรายได้ระดับกลาง",
                    "allocations": [
                ...
                {
                    "plan_type": "balanced",
                    "description": "กระจายความเสี่ยงระหว่างประกันและกองทุน RMF สมดุลระหว่างความคุ้มครองและผลตอบแทนระยะยาว",
                    "allocations": [
                        {"category": "ประกันชีวิต", "percentage": 20, "risk_level": "low",
                         "pros": ["ให้ความคุ้มครองชีวิต"], "cons": ["ผลตอบแทนต่ำ"]},
                        {"category": "ประกันสุขภาพ", "percentage": 10, "risk_level": "low",
                ...
                {
                    "plan_type": "growth",
                    "description": "เน้นลดหย่อนภาษีสูงสุดด้วย RMF และ ThaiESG ใช้วงเงินเต็มที่เพื่อผลตอบแทนระยะยาว",
                    "allocations": [
                        {"category": "ประกันชีวิต", "percentage": 10, "risk_level": "low",
                         "pros": ["ให้ความคุ้มครองชีวิต"], "cons": ["ผลตอบแทนต่ำ"]},
        ...
        ("high", "low"): {
            "plans": [
                {
                    "plan_type": "conservative",
                    "description": "เน้นความคุ้มครองครบถ้วนด้วยประกันชีวิตและสุขภาพเต็มวงเงิน เหมาะกับรายได้สูงที่เน้นความปลอดภัย",
                    "allocations": [
                        {"category": "ประกันชีวิต", "percentage": 30, "risk_level": "low",
                         "pros": ["ให้ความคุ้มครองชีวิต", "ลดหย่อนภาษี"], "cons": ["ผลตอบแทนต่ำ"]},
                        {"category": "ประกันสุขภาพ", "percentage": 10, "risk_level": "low",
                ...
                {
                    "plan_type": "balanced",
                    "description": "กระจายความเสี่ยงระหว่างประกันครบด้านและกองทุน RMF สมดุลเน้นความมั่นคงระยะยาวสำหรับรายได้สูง",
                    "allocations": [
                        {"category": "ประกันชีวิต", "percentage": 15, "risk_level": "low",
                         "pros": ["ให้ความคุ้มครองชีวิต"], "cons": ["ผลตอบแทนต่ำ"]},
                        {"category": "ประกันสุขภาพ", "percentage": 5, "risk_level": "low",
                ...
                {
                    "plan_type": "growth",
                    "description": "เน้นลดหย่อนภาษีสูงสุดแบบปลอดภัย ใช้วงเงินเต็มทั้ง RMF ThaiESG และประกันบำนาญ",
                    "allocations": [
                        {"category": "ประกันชีวิต", "percentage": 10, "risk_level": "low",
                         "pros": ["ให้ความคุ้มครองชีวิต"], "cons": ["ผลตอบแทนต่ำ"]},
                        ...
                        {"category": "เงินบริจาคการศึกษา", "percentage": 15, "risk_level": "low",
                         "pros": ["ลดหย่อนได้ 2 เท่า"], "cons": ["ไม่ได้ผลตอบแทนกลับ"]},
                    ]
                },
            ]
        },
        ("high", "medium"): {
            "plans": [
                {
                    "plan_type": "conservative",
                    "description": "เน้นความคุ้มครองด้วยประกันชีวิตและสุขภาพ เสริมด้วยประกันบำนาญสำหรับรายได้สูง",
                    "allocations": [
                        {"category": "ประกันชีวิต", "percentage": 30, "risk_level": "low",
                         "pros": ["ให้ความคุ้มครองชีวิต", "ลดหย่อนภาษี"], "cons": ["ผลตอบแทนต่ำ"]},
                        {"category": "ประกันสุขภาพ", "percentage": 10, "risk_level": "low",
                ...
                {
                    "plan_type": "balanced",
                    "description": "กระจายความเสี่ยงอย่างสมดุลระหว่างประกันและ RMF/ThaiESG สำหรับรายได้สูงที่ต้องการผลตอบแทนปานกลาง",
                    "allocations": [
                        {"category": "ประกันชีวิต", "percentage": 15, "risk_level": "low",
                         "pros": ["ให้ความคุ้มครองชีวิต"], "cons": ["ผลตอบแทนต่ำ"]},
                        {"category": "ประกันสุขภาพ", "percentage": 5, "risk_level": "low",
                ...
                {
                    "plan_type": "growth",
                    "description": "เน้นลดหย่อนภาษีสูงสุด ใช้วงเงิน RMF ThaiESG และเงินบริจาคการศึกษาเต็มที่",
                    "allocations": [
                        {"category": "ประกันชีวิต", "percentage": 10, "risk_level": "low",
                         "pros": ["ให้ความคุ้มครองชีวิต"], "cons": ["ผลตอบแทนต่ำ"]},
        ...
        ("high", "high"): {
            "plans": [
                {
                    "plan_type": "conservative",
                    "description": "เน้นความคุ้มครองพื้นฐานด้วยประกันชีวิตและสุขภาพ สร้างฐานความมั่นคงสำหรับรายได้สูง",
                    "allocations": [
                        {"category": "ประกันชีวิต", "percentage": 30, "risk_level": "low",
                         "pros": ["ให้ความคุ้มครองชีวิต", "ลดหย่อนภาษี"], "cons": ["ผลตอบแทนต่ำ"]},
                        {"category": "ประกันสุขภาพ", "percentage": 10, "risk_level": "low",
                ...
                {
                    "plan_type": "balanced",
                    "description": "กระจายความเสี่ยงระหว่างประกันและกองทุน RMF/ThaiESG สมดุลระหว่างความคุ้มครองและผลตอบแทนสูง",
                    "allocations": [
                        {"category": "ประกันชีวิต", "percentage": 15, "risk_level": "low",
                         "pros": ["ให้ความคุ้มครองชีวิต"], "cons": ["ผลตอบแทนต่ำ"]},
                        {"category": "ประกันสุขภาพ", "percentage": 5, "risk_level": "low",
                ...
                {
                    "plan_type": "growth",
                    "description": "เน้นลดหย่อนภาษีสูงสุดด้วย RMF และ ThaiESG ใช้วงเงินเต็มที่ลงทุนเพื่อผลตอบแทนระยะยาว",
                    "allocations": [
