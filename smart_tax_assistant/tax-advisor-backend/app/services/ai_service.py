...
- ประกันชีวิต + สุขภาพ: รวมกันสูงสุด 100,000 บาท (FIXED LIMIT)
- ประกันสุขภาพ: สูงสุด 25,000 บาท (แต่รวมกับประกันชีวิตต้องไม่เกิน 100,000)
- ประกันบำนาญ: สูงสุด min(200,000, 15% ของรายได้) = {min(200000, int(gross * 0.15)):,.0f} บาท (ถ้าไม่มีประกันชีวิตเลยสูงสุด 300,000)
- ประกันสังคม: มาตรา 33=9,000 / มาตรา 39=5,184 / มาตรา 40=3,600 บาท

กลุ่มกองทุนและการลงทุน (สำหรับ 40(6) และ 40(8) เท่านั้น):
- RMF: สูงสุด min(500,000, 30% ของรายได้) = {max_rmf:,.0f} บาท
- ThaiESG/ThaiESGX: สูงสุด min(300,000, 30% ของรายได้) = {min(300000, int(gross * 0.30)):,.0f} บาท แต่ละกอง (วงเงินแยกกัน)
- RMF + ประกันบำนาญ + กอช. รวมกันต้องไม่เกิน 500,000 บาท
- หมายเหตุ: PVD/กบข./กบศ. ใช้ได้เฉพาะ 40(1) เงินเดือน ห้ามแนะนำสำหรับ 40(6)/40(8)

กลุ่มอื่นๆ:
- Easy e-Receipt: สูงสุด 50,000 บาท (FIXED LIMIT)
- เงินบริจาคทั่วไป: สูงสุด 10% ของเงินได้หลังหักค่าลดหย่อนอื่นๆ
- เงินบริจาคเพื่อการศึกษา/กีฬา/สถานพยาบาลรัฐ: นับ 2 เท่า สูงสุด 10% ของเงินได้
...
9. รายได้ 1,500,000+ ควรพิจารณาเงินบริจาคการศึกษา/กีฬา/สถานพยาบาลรัฐ (นับ 2 เท่า สูงสุด 10% ของเงินได้)
